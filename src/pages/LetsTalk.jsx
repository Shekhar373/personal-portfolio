...
const LetsTalk = () => {
  ...
  return (
    <div className='lg:h-screen max-sm:h-[60vh] md:h-[80vh] w-full flex flex-col justify-center lg:leading-36 max-sm:leading-12 md:leading-20 max-xl:leading-52 items-center'>
