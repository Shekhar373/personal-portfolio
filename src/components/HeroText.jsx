    ...
    return (
        <div className='lg:h-[90vh] sm:h-[60vh] md:h-[70vh] w-full'>
            ...
            <div className='relative'>
                <div className='lg:text-[15vw] max-sm:text-[28vw] max-sm:leading-32  md:text-[25vw] md:items-center md:leading-[15vh] md:flex  lg:pt-20 font-bold lg:flex gap-1.5 justify-center relative z-20'>
                ...
                <div className=' max-md:flex max-sm:pl-8 max-md:flex-col'>
                    ...
                    <div className=' india  md:flex gap-15  flex lg:text-xl lg:absolute md:text-3xl  lg:right-9 lg:top-52 lg:tracking-[1.3vw] md:tracking-[3.7vw] md:justify-center max-sm:tracking-[3.7vw]'>
                        <h1>BASED</h1>
                        <h1>IN</h1>
                        <h1>INDIA</h1>
                    </div>
                    <div className='h-[32vh] w-full flex lg:justify-center relative  '>
                        <div className=' skill h-full lg:w-[40%]  flex flex-col lg:justify-end text-2xl max-sm:pl-55 max-sm:pt-50  font-medium max-sm:leading-6
                         '>
                            <h1>/WEB DESIGNER</h1>
