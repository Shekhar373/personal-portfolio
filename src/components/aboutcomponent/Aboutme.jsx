...
const Aboutme = () => {
  ...
  return (
    <div className='h-screen  w-full '>
      ...
      <div className='about-text text-2xl  h-screen w-full flex flex-col sm:px-10 sm:text-3xl md:justify-center md:items-center md:px-40 md:text-3xl lg:px-70 lg:text-4xl px-10 text-center  '>
